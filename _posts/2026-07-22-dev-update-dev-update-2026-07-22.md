...
---
## New & Improved
- Daily curation 2026-07-21 - automated content aggregation
- Daily content article - 2026-07-21
- Daily curation 2026-07-20 - automated content aggregation
- Daily content article - 2026-07-20
- Daily curation 2026-07-19 - automated content aggregation
- Daily content article - 2026-07-19
## Y Fixes & Polish
- add theme-var fallbacks to goal onboarding modal so it renders visible + closeable
- skip puppeteer Chrome download on CF Pages
- publish Privacy Policy to /privacy/ and /privacy-policy/ (P0 audit gap)
## asTMi Under the Hood
- audit(research): correct HRTO + WSIAT stats to committed-data reality (subagent verification)
- audit(research): ONCA 58.1% label fix + BC WCAT unverified-status (subagent findings)
- audit(research): repo-wide accuracy sweep 2026-07-20 (post laptop-failure)
---
