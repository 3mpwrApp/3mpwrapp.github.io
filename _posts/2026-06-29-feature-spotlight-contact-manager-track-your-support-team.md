---
layout: post
title: "Feature Spotlight: Contact Manager: Track Your Support Team"
date: 2026-06-29 00:00:00 +0000
tags: [features, spotlight, productivity-tools]
categories: [features]
excerpt: Organize support contacts
---
# Feature Spotlight: Contact Manager: Track Your Support Team
**Category:** Productivity Tools
Organize support contacts
---
## What Is Contact Manager: Track Your Support Team?
Contact Manager: Track Your Support Team is designed to organize support contacts. This feature is part of 3mpwrApp's commitment to providing comprehensive tools for people with disabilities, injured workers, and their supporters across Canada.
---
## Key Highlights
...
An injured worker is preparing an appeal while managing medical appointments and family responsibilities. They use Contact Manager: Track Your Support Team to reduce one major barrier so their limited energy can go toward decisions that affect outcomes.
...
- Process: Contact Manager: Track Your Support Team structures the work so key steps are easier to complete.
...
---
## Why Contact Manager: Track Your Support Team Matters
- Accountability
---
## Getting Started
Ready to try Contact Manager: Track Your Support Team? Here's how to get started:
1. **Open 3mpwrApp** - Start here: https://3mpwrapp.pages.dev/
2. **Complete setup** - Takes just 5 minutes
3. **Find the feature** - Look for "Contact Manager: Track Your Support Team" in your app
4. **Follow the guide** - In-app tutorials walk you through each step
---
## Learn More
For complete information about Contact Manager: Track Your Support Team and all other features:
- [Read the Complete User Guide](/user-guide/#contact-manager)
