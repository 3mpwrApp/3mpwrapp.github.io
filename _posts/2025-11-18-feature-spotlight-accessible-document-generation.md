...
# Feature Spotlight: Accessible Document Generation

**Category:** Legal Tools

Generate WCAG 2.2 AA+ compliant documents, letters, and forms with proper structure

* * *

## What Is Accessible Document Generation?

Accessible Document Generation is designed to generate wcag 2.2 aa+ compliant documents, letters, and forms with proper structure. This feature is part of 3mpwrApp's commitment to providing comprehensive tools for people with disabilities, injured workers, and their supporters across Canada.
...
Here are real examples of how you can use Accessible Document Generation:

1. Generate accommodation letter accessible to all recipients
2. Create appeal document with proper structure
3. Export in format your lawyer or advocate needs
4. Ensure accessibility officer can read your request
5. Print documents with clear, readable formatting

* * *

## Why Accessible Document Generation Matters
...
Ready to try Accessible Document Generation? Here's how to get started:

1. **Download the app** - Available on iOS and Android (coming soon)
2. **Complete setup** - Takes just 5 minutes
3. **Find the feature** - Look for "Accessible Document Generation" in your app
...
For complete information about Accessible Document Generation and all other features:

- ðŸ“– [Read the Complete User Guide](/user-guide/#document-generation)
