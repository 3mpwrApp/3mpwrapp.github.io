...
# Feature Spotlight: Policy Explainer (Policy Made Simple)
...
Here are real examples of how you can use Policy Explainer (Policy Made Simple):

1. Input: Complex benefits denial letter
...
Ready to try Policy Explainer (Policy Made Simple)? Here's how to get started:
