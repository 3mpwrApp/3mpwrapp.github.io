...
**Statistical anomaly:**
These megaprojects reported injury rates significantly below industry averages for comparable construction—**not because they're safer, but because injuries aren't being officially reported**.
...
## ⚖️ Legal Breakthrough: *Pickering v WCB* (2025)
...
| WCB claim filed | _________ |  |
| First discipline/change in treatment | _________ | If <60 days: YES |
| Escalation (2nd discipline, demotion, etc.) | _________ | If <90 days: YES |
| Termination | _________ | If <90 days: VERY YES |
