...
- **Always free - no premium features or paywalls** --- ## How It Works Here are real examples of how you can use Mood Tracker: 1. Record mood each morning and evening
...
5. Spot connections between activities and mood --- ## Why Mood Tracker Matters - Better understand your emotional patterns
- Communicate more clearly with healthcare providers
- Identify triggers and helpful activities
- Track progress in mental health treatment --- ## Getting Started Ready to try Mood Tracker? Here's how to get started: 1. **Download the app** - Available on iOS and Android (coming soon)
2. **Complete setup** - Takes just 5 minutes
3. **Find the feature** - Look for "Mood Tracker" in your app
4. **Follow the guide** - In-app tutorials walk you through each step --- ## Learn More For complete information about Mood Tracker and all other features: - [Read the Complete User Guide](/user-guide/#mood-tracker)
