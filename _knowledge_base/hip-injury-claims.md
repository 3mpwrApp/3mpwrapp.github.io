...
layout: page
title: "Hip Injury"
permalink: /knowledge-base/hip-injury-claims/
---
...
1. **Denies initial hip claim** → years later when hip replacement needed, says "hip arthritis was denied, hip replacement not our responsibility"
2. **IME says "not severe enough for surgery"** (contradicts treating orthopedic surgeon)
3. **Delays surgery authorization** → hip deteriorates further → claims "now too severe, must be other factors"
...
3. **Get causation opinion from orthopedic surgeon:**
   - "Is my hip osteoarthritis/labral tear work-related?"

4. **If denied, APPEAL using *Pasiechnyk* framework and occupational research**
