...
**Default:** OFF (analytics enabled, but you can opt out anytime)
...
- [Data Ownership Statement](https://3mpwrapp.pages.dev/data-ownership)
- [Delete Your Account](https://3mpwrapp.pages.dev/delete-account)
- [Delete Your Data](https://3mpwrapp.pages.dev/delete-data)
