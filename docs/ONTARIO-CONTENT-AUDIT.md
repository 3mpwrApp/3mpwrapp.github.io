...
- **Total Files Scanned:** 1719
- **Files with Tribunal Mentions:** 276
- **Total Links Found:** 2618
- **Broken Internal Links:** 927
- **Statistical Inconsistencies:** 107
...
- [`CONTENT_OPTIMIZATION_TEMPLATES.md`](CONTENT_OPTIMIZATION_TEMPLATES.md) - 9 mentions
- [`data\appeal-templates\back-injury-appeal.md`](data\appeal-templates\back-injury-appeal.md) - 2 mentions
- [`data\appeal-templates\chronic-pain-appeal.md`](data\appeal-templates\chronic-pain-appeal.md) - 2 mentions
- [`data\appeal-templates\pre-existing-appeal.md`](data\appeal-templates\pre-existing-appeal.md) - 5 mentions
...
- [`data\appeal-templates\back-injury-appeal.md`](data\appeal-templates\back-injury-appeal.md) - 2 mentions
- [`data\appeal-templates\chronic-pain-appeal.md`](data\appeal-templates\chronic-pain-appeal.md) - 1 mentions
- [`data\knowledge-base\bill-86-meredith-act.md`](data\knowledge-base\bill-86-meredith-act.md) - 3 mentions
- [`data\knowledge-base\fibromyalgia-claims.md`](data\knowledge-base\fibromyalgia-claims.md) - 1 mentions
- [`data\knowledge-base\permanent-impairment-rating.md`](data\knowledge-base\permanent-impairment-rating.md) - 1 mentions
- [`data\knowledge-base\pre-existing-conditions.md`](data\knowledge-base\pre-existing-conditions.md) - 1 mentions
...
- [`docs\CANLII_OUTCOME_DEPLOYMENT_COMPLETE_2026-04-28.md`](docs\CANLII_OUTCOME_DEPLOYMENT_COMPLETE_2026-04-28.md) - 3 mentions
- [`docs\CANLII_OUTCOME_METADATA_PARTNERSHIP_REQUEST_2026-04-29.md`](docs\CANLII_OUTCOME_METADATA_PARTNERSHIP_REQUEST_2026-04-29.md) - 1 mentions
- [`docs\COMPLETE_CANLII_COLLECTION_PLAN_2026-04-27.md`](docs\COMPLETE_CANLII_COLLECTION_PLAN_2026-04-27.md) - 26 mentions
- [`docs\COMPREHENSIVE-PARSING-SUMMARY-2026-04-30.md`](docs\COMPREHENSIVE-PARSING-SUMMARY-2026-04-30.md) - 7 mentions
- [`docs\COMPREHENSIVE_EXECUTION_PLAN.md`](docs\COMPREHENSIVE_EXECUTION_PLAN.md) - 12 mentions
- [`docs\CORRECTED-WORKFLOW-OUTCOME-EXTRACTION.md`](docs\CORRECTED-WORKFLOW-OUTCOME-EXTRACTION.md) - 7 mentions
...
- [`content-queue\month1-complete-calendar.md`](content-queue\month1-complete-calendar.md) - 16 mentions
- [`content-queue\week1-content.md`](content-queue\week1-content.md) - 3 mentions
- [`data\tribunal-decisions\app-export\README.md`](data\tribunal-decisions\app-export\README.md) - 1 mentions
- [`data\tribunal-decisions\detective-analysis\ABANDONED-CASES-REPORT.md`](data\tribunal-decisions\detective-analysis\ABANDONED-CASES-REPORT.md) - 7 mentions
- [`data-limitations.md`](data-limitations.md) - 4 mentions
- [`docs\8PM_LAUNCH_CHECKLIST.md`](docs\8PM_LAUNCH_CHECKLIST.md) - 1 mentions
...
### [`ACTIVATION.md`](ACTIVATION.md) Line 206
...
### [`ar\index.md`](ar\index.md) Line 13
- **Link:** `{{ '/whats-new' | relative_url }}`
- **Text:** "آخر التحديثات"
- **Attempted:** D:\1-EmpowrApp\empowrapp-site\3mpwrapp.github.io-main\3mpwrapp.github.io-main\ar\{{ '\whats-new' | relative_url }}, D:\1-EmpowrApp\empowrapp-site\3mpwrapp.github.io-main\3mpwrapp.github.io-main\ar\{{ '\whats-new' | relative_url }}.md

### [`beta-guide\index.md`](beta-guide\index.md) Line 16
- **Link:** `/whats-new/2026-02-24-documentation-sync-en-fr-legal/#core-user-docs-en`
- **Text:** "Documentation Sync Complete → Core user docs (English)"
- **Attempted:** D:\1-EmpowrApp\empowrapp-site\3mpwrapp.github.io-main\3mpwrapp.github.io-main\whats-new\2026-02-24-documentation-sync-en-fr-legal\, D:\1-EmpowrApp\empowrapp-site\3mpwrapp.github.io-main\3mpwrapp.github.io-main\whats-new\2026-02-24-documentation-sync-en-fr-legal\.md

### [`blog\2026-04-08-social-media-posts.md`](blog\2026-04-08-social-media-posts.md) Line 704
- **Link:** `LINK`
...
### [`blog\2026-04-08-social-media-posts.md`](blog\2026-04-08-social-media-posts.md) Line 710
- **Link:** `LINK`
- **Text:** "View on GitHub"
- **Attempted:** D:\1-EmpowrApp\empowrapp-site\3mpwrapp.github.io-main\3mpwrapp.github.io-main\blog\LINK, D:\1-EmpowrApp\empowrapp-site\3mpwrapp.github.io-main\3mpwrapp.github.io-main\blog\LINK.md
...
### [`blog\index.md`](blog\index.md) Line 25
- **Link:** `{{ '/research' | relative_url }}`
- **Text:** "📚 Research Hub"
- **Attempted:** D:\1-EmpowrApp\empowrapp-site\3mpwrapp.github.io-main\3mpwrapp.github.io-main\blog\{{ '\research' | relative_url }}, D:\1-EmpowrApp\empowrapp-site\3mpwrapp.github.io-main\3mpwrapp.github.io-main\blog\{{ '\research' | relative_url }}.md


*...and 907 more broken links*


## ⚠️ Statistical Inconsistencies (107)

### [`data\comprehensive-extraction\blog-post-snippet.md`](data\comprehensive-extraction\blog-post-snippet.md) Line 60
- **Tribunal:** WSIAT
- **Expected:** 89.1%
- **Found:** 70%
- **Difference:** 19.1%
- **Context:** "limitations, this is the first comprehensive outcome analysis of recent WSIAT decisions. The 89.1% win rate for clear outcomes is consistent with WSIAT's reported 60-70% worker success rate.  ---  **"

### [`data-limitations.md`](data-limitations.md) Line 212
- **Tribunal:** ONSBT
- **Expected:** 98.9%
- **Found:** 60%
- **Difference:** 38.9%
...
- **Found:** 100%
- **Difference:** 10.9%
- **Context:** "**Statistics script path issues:** Required 3 attempts to find correct relative path - **WSIAT 100% win rate:** AI predictions overstate WSIAT success (likely data quality issue, not real 100%) - **Lo"
...
- **Found:** 63.1%
- **Difference:** 26.0%
- **Context:** "* **+49.0 percentage points** 🎉  ## What We Extracted  ### WSIAT Outcomes Detected (651 cases) - **Allowed** (worker victory): 411 (63.1%) - **Dismissed** (board victory): 202 (31.0%) - **Varied** (p"

### [`docs\NLP_OUTCOME_PREDICTION_RESULTS_2026-04-27.md`](docs\NLP_OUTCOME_PREDICTION_RESULTS_2026-04-27.md) Line 73
- **Tribunal:** WSIAT
- **Expected:** 89.1%
- **Found:** 100%
- **Difference:** 10.9%
- **Context:** "E PREDICTIONS (Needs Improvement)  #### WSIAT Ultra-Slow Files (2020-2026) All predictions: **100% "Granted"** with **100% low confidence (<60%)**  - onwsiat-2020-ultra-slow.json: 2,077 predicted → Al"

### [`docs\NLP_OUTCOME_PREDICTION_RESULTS_2026-04-27.md`](docs\NLP_OUTCOME_PREDICTION_RESULTS_2026-04-27.md) Line 102
- **Tribunal:** WSIAT
- **Expected:** 89.1%
- **Found:** 58.1%
- **Difference:** 31.0%
- **Context:** "## Why WSIAT Ultra-Slow Files Have Low Confidence?  **Problem:** Model defaults to majority class ("Granted" = 58.1% of training data) when features are weak.  **Root Causes:** 1. **Sparse Metadata:**"

### [`docs\NLP_OUTCOME_PREDICTION_RESULTS_2026-04-27.md`](docs\NLP_OUTCOME_PREDICTION_RESULTS_2026-04-27.md) Line 110
- **Tribunal:** WSIAT
- **Expected:** 89.1%
- **Found:** 14%
- **Difference:** 75.1%
- **Context:** "**Evidence:** - Historical WSIAT file (4,006 predictions) achieved 99.9% high confidence with 86% Allowed / 14% Dismissed distribution - Ultra-slow files (11,430 predictions) ALL defaulted to "Grant"
...
- **Found:** 100%
- **Difference:** 16.7%
- **Context:** "predictions (ALL low confidence) ⚠️  #### WSIB Files (First-Level Appeals) All predictions: **100% "Granted"** with **100% low confidence**  - onwsib-2021-complete.json: 28 predicted - onwsib-2022-com"

### [`docs\partnerships\TBDIWSG_FLYWHEELS_PILOT_PROPOSAL.md`](docs\partnerships\TBDIWSG_FLYWHEELS_PILOT_PROPOSAL.md) Line 132
- **Tribunal:** WSIAT
- **Expected:** 89.1%
- **Found:** 78%
- **Difference:** 11.1%
- **Context:** "bromyalgia Success Factors** ``` Detected Pattern: - 73 fibromyalgia WSIAT appeals in database - 57 allowed (78% success rate) - Success factors present in 87% of wins:   1. RFC form from treating phy"

### [`docs\partnerships\TBDIWSG_FLYWHEELS_PILOT_PROPOSAL.md`](docs\partnerships\TBDIWSG_FLYWHEELS_PILOT_PROPOSAL.md) Line 496
- **Tribunal:** WSIAT
- **Expected:** 89.1%
- **Found:** 78%
- **Difference:** 11.1%
- **Context:** "ion:** Fibromyalgia   **Jurisdiction:** Ontario (WSIAT)   **Sample Size:** 73 cases (2015-2025)   **Success Rate:** 78% (57 allowed, 16 denied)    **Success Factors (Present in Wins):** 1. **RFC Form"


*...and 92 more inconsistencies*


## Recommendations

1. **Fix Broken Links:** 927 internal links need correction
2. **Update Statistics:** 107 files have outdated or incorrect statistics
