...
1. Download 3mpwrApp from Google Play Store or Apple App Store
2. Install the app on your device (requires Android 5.0+ or iOS 13+)
3. Grant necessary permissions (optional: camera for Evidence Locker, notifications)
...
See full Privacy Policy at: https://empowr.app/privacy
...
See full Community Guidelines at: https://empowr.app/community-guidelines
...
- High Contrast Mode
- Large Text (up to 300% scaling)
- Dyslexia-Friendly Fonts (OpenDyslexic)
- Adjustable letter/line spacing
- Color contrast WCAG AAA compliant

### **Motor Accessibility:**
- Large touch targets (48x48dp minimum)
- Dwell Click (touch-free interaction)
- Tremor Reduction (stabilizes shaky input)
- One-Handed Mode
...
- Scroll Memory (remembers position)
- Complexity Indicators

### **Hearing Accessibility:**
- Visual Alerts (no audio required)
...
### **Social Media:**
- Twitter: @3mpwrApp (coming soon)
- Instagram: @3mpwrApp (coming soon)
- Reddit: r/3mpwrApp (coming soon)
...
### **Documentation:**
- Terms of Service: https://empowr.app/terms
- Privacy Policy: https://empowr.app/privacy
- Community Guidelines: https://empowr.app/community-guidelines
- Accessibility Statement: https://empowr.app/accessibility
