...
- Set province (Settings → Local Profile) for region-aware Resources.
- Add one note to Evidence Locker and tag it.
- Add one deadline with a reminder.
- Save one video and one resource you find helpful.
- Export a backup (Settings → Privacy & Backups).

## Tips

- Accessibility: Use High Contrast (top-right) and system text scaling.
- Privacy: Most data is local unless you enable optional cloud features or share/export.
- Short routines: Small, consistent steps beat big leaps. Try Daily Energy Coins with 10–12 coins.
