...
permalink: /templates/onca-notice-of-appeal/
---
...
1. **Precise relief sought** - What you want ONCA to order
2. **Grounds of appeal** - Legal errors you allege (be specific, not general)
3. **Material facts** - Key facts supporting your grounds (briefly)
4. **Legal basis** - Statutes/cases supporting your position
5. **Order under appeal** - Exact order you're challenging
...
1. **Standard of review error** - Court below applied wrong standard (correctness instead of reasonableness, or vice versa)
2. **Misapplication of legal test** - Court/tribunal applied wrong legal framework (e.g., wrong test for causation)
3. **Procedural fairness breach** - Denial of natural justice, bias, or failure to provide fair hearing
4. **Jurisdictional error** - Tribunal exceeded its statutory authority
5. **Failure to consider binding precedent** - Court/tribunal ignored applicable case law

### ❌ Weak Grounds (Rarely succeed):

1. **"The decision was wrong"** - Not a legal error; must show **how** the legal reasoning was flawed
2. **Factual disagreements** - ONCA defers to trial judges/tribunals on facts and credibility
3. **Weight of evidence** - Court below entitled to prefer one expert over another
4. **Inadequacy of reasons** - Unless reasons are unintelligible, ONCA defers
5. **Sympathy appeals** - "I really need this outcome" is not a ground of appeal
...
- **Appellant's Factum** - Your legal argument (max 40 pages) - [Use our template](/templates/onca-factum-template/)
...
>
> 7. The Tribunal erred by requiring the appellant to prove that workplace duties were the **sole cause** of the back injury, when section 13(1) of the *Workplace Safety and Insurance Act* requires only that the injury "arise out of" employment.
>
> 8. Material facts: The Tribunal found at paragraph 12 that the appellant had "pre-existing degenerative disc disease" and concluded this "broke the chain of causation." The Tribunal's decision does not cite *Athey v. Leonati*, [1996] 3 SCR 458, which holds that pre-existing conditions do not negate causation if the workplace materially contributed to the injury.
>
> 9. Legal basis: The "arising out of" test requires only **material contribution**, not sole causation (*WSIAT v. Jones* (fictional), 2021 ONCA 234, at para. 45). The Tribunal's "sole cause" approach contradicts 30 years of ONCA jurisprudence.

### Bad Example (Vague, argumentative, not a legal error):

> **GROUND 2: THE DECISION WAS WRONG AND UNFAIR**
>
> 7. The Tribunal made the wrong decision. I clearly was injured at work and deserve benefits.
>
> 8. The doctor said I had a back injury. WSIB should have accepted this.
>
> 9. It is unfair that I don't get benefits when I can't work.
...
- [Leave to Appeal Application Template](/templates/onca-leave-to-appeal-application/) - For seeking permission to appeal
...
**Maintained by:** [3mpwr App](https://3mpwrapp.ca)
