...
export const ANALYTICS_EVENT_SCHEMAS: Record<string, EventSchema> = {
  ...
  [E.MENTOR_LOAD_MORE]: { offset: { type: 'number' } },
  [E.MENTOR_MESSAGE_INITIATED]: { mentorId: { type: 'string', required: true } },
  [E.MENTOR_PROFILE_VIEW]: { mentorId: { type: 'string', required: true } },
  [E.MENTOR_REQUEST_SENT]: { mentorId: { type: 'string', required: true } },
  [E.MENTOR_SEARCH]: { query: { type: 'string' }, total: { type: 'number' } },
