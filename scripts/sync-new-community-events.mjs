...
const events = [
  {
    ...
    energyCost: 'medium',
    imageUrl: '',
    endDate: '2025-11-25T19:00:00.000Z',
  ...
  {
    id: 'evt-thunder-bay-rally-dec8-2025',
    title: 'TBDIWSG December 8th Rally - Lise Vaugeois Office',
    description: 'The Thunder Bay & District Injured Workers Support Group is organizing a rally on December 8th, 2025 at Lise Vaugeois\' office.\n\nDate: Monday, December 8th, 2025\nTime: 11am - 1pm\nLocation: 272 Park Street, Thunder Bay\n\nJoin us to:\n• Stand with injured workers\n• Advocate for workers\' rights\n• Demand accountability and justice\n\nFor updates and more information, visit: https://thunderbayinjuredworkers.com/\n\nContact: tbiwsg@gmail.com',
    date: '2025-12-08T16:00:00.000Z',
    time: '11:00',
    duration: 120,
    location: 'Lise Vaugeois Office, 272 Park Street, Thunder Bay, Ontario',
    isVirtual: false,
    category: 'advocacy',
    tags: [
      'injured-workers',
    ...
    energyCost: 'medium',
    imageUrl: '',
    endDate: '2025-12-08T18:00:00.000Z',
    accessibilityNotes: 'Outdoor rally at Lise Vaugeois office, 272 Park Street. Contact organizers at tbiwsg@gmail.com for accessibility accommodations and parking information.',
    asl: false,
    captions: false,
    stepFree: true,
    wheelchairAccessible: true,
