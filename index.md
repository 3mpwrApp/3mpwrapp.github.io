...
(function() {
  ...
  const encouragements = [
    ...
    "🌸 It's okay to have messy, complicated feelings",
  ...
  const websiteTidbits = [
    ...
    "📱 Design: Our buttons are minimum 44x44px for easy touch targets",
    "🎨 Design: All text meets WCAG AAA contrast standards (7:1 ratio)",
    "♿ Design: Every interactive element is keyboard accessible - no mouse needed",
    "🗣️ Design: Screen readers announce all changes and updates automatically",
    "🧭 Design: Skip navigation links let you jump straight to main content",
    "📐 Design: Text can zoom to 200% without breaking the layout",
    "🎯 Design: Focus indicators are clearly visible on all interactive elements",
    "💡 Feature: Page sections have energy cost estimates (light/medium/heavy)",
    "🔄 Feature: Live community counter shows real-time active users",
    "📖 Feature: Reading time estimates at the top of every article",
    "🎊 Feature: Visit counter celebrates your milestones (5, 10, 25 visits!)",
    "⏱️ Feature: After 5 minutes reading, we remind you to stretch",
    "📍 Feature: Scroll depth tracker encourages you at 50% and 100%",
    "👋 Feature: Welcome back message when you return after being idle",
    "🎄 Feature: Seasonal messages for Disability Pride, Labour Day, and more",
    "🗺️ Feature: First-time visitor tour guides you through the site",
    "💪 Feature: Solidarity messages remind you you're part of a movement",
    "🎨 Feature: Three different colored boxes for different message types",
    "⏰ Feature: Time-aware messages (late night, early morning, lunch, evening)",
    "🎉 Feature: Confetti animation when you unlock easter eggs",
    "💬 Feature: Page feedback buttons to tell us what's helpful",
    "🔗 Feature: Crisis resources banner always accessible at bottom of pages",
    "📋 Feature: Copy-paste friendly - all content is plain text accessible",
    "🖱️ Feature: All hover effects have equivalent keyboard/touch alternatives",
    "🌈 Feature: Custom CSS variables make theming flexible and accessible",
    "🎯 Feature: Reduced motion mode respects your system preferences",
    "📱 Feature: Mobile-first responsive design works on any screen size",
    "🔊 Feature: No auto-playing audio or video - you're in control",
    "🎨 Feature: High contrast mode for better visibility",
    "💾 Feature: Local storage respects your privacy - no external tracking",
    "🔐 Feature: No cookies required for basic site functionality",
    "⚡ Feature: Lightweight pages load fast even on slow connections",
    "📊 Feature: Beta testing phase means your feedback shapes the app",
    "🆓 Feature: 100% free forever - no premium tiers or paywalls",
    "💚 Feature: Community-driven development - built by disabled people for disabled people",
    "🌍 Feature: Province-specific community spaces for local support",
    "📚 Feature: Educational resources library with templates and guides",
    "🎙️ Feature: Podcasts section for audio content accessibility",
    "📰 Feature: Daily curated highlights from across Canada",
    "📅 Feature: Weekly update carousel shows latest community news",
    "🔍 Feature: Searchable blog with tags and categories",
    "👥 Feature: Connect with others through shared experiences",
    "✊ Feature: Advocacy tools and campaign resources for social change"
  ];
  ...
  const movementFacts = [
    ...
    "📊 Reality: 27% of disabled Canadians live in poverty vs 12% of non-disabled (Stats Canada)",
    "🏠 Housing: Disabled Canadians are 2x more likely to have housing affordability issues",
    "🚗 Transportation: 20% of disabled Canadians report transportation barriers affecting employment",
    "💼 Underemployment: 41% of disabled workers feel overqualified for their current jobs",
    "🎓 Education: Disabled students graduate university at same rates as non-disabled peers",
    "🏥 Healthcare: Average wait for specialists is 60% longer for disabled patients",
    "💊 Medication: 1 in 3 disabled Canadians can't afford prescribed medications",
    "🧠 Mental Health: Anxiety and depression affect 45% of Canadians with physical disabilities",
    "👨‍🦽 Mobility: Only 38% of buildings in Canada are fully accessible (Rick Hansen Foundation)",
    "🚌 Transit: 23% of disabled Canadians avoid public transit due to accessibility barriers",
    "💻 Digital: 70% of websites fail basic accessibility standards (WCAG 2.0)",
    "📱 Technology: Assistive devices can cost $5,000-$40,000 with limited government funding",
    "⚖️ Legal: Human rights complaints for disability discrimination increased 40% since 2015",
    "🎯 Employment: Only 24% of employers actively recruit people with disabilities",
    "📚 Literacy: Plain language accessibility benefits 54% of all Canadians, not just disabled",
    "🏢 Remote Work: Pandemic proved 60% of jobs can be done remotely - more opportunities!",
    "💪 Advocacy: Disabled-led organizations are 5x more effective than non-disabled-led ones",
    "🌍 Global: Canada ranks 21st out of 29 developed countries for disability inclusion (OECD)",
    "🎓 Youth: 1 in 5 young adults (15-24) in Canada has a disability",
    "👴 Seniors: By age 75, over 50% of Canadians will have a disability",
    "💼 Self-employment: 15% of disabled workers are self-employed vs 11% of non-disabled",
    "🏥 Doctors: Only 15% of medical schools have disability curriculum requirements",
    "🎭 Media: Less than 3% of TV characters are disabled (and usually played by non-disabled actors)",
    "📊 Invisible: 80% of disabilities are invisible - don't assume based on appearance",
    "🏛️ History: Section 15 of Charter guarantees disability rights since 1982",
    "✊ Protests: Disability rights activists occupied Parliament in 1985 for equality",
    "📜 Victory: Supreme Court ruled in Eldridge (1997) that deaf patients need interpreters",
    "🎯 Milestones: First disabled MP elected to Parliament in 2008 (Steven Fletcher)",
    "🏆 Champions: Rick Hansen wheeled around the world (1985-87) raising awareness",
    "💚 Community: Disabled people are the largest minority group globally (15% of population)",
    "🌈 Intersectionality: Disabled BIPOC, 2SLGBTQIA+ face compounded discrimination",
    "⚖️ Justice: Disabled prisoners are 4x more likely to be in solitary confinement",
    "👩‍⚖️ Courts: Only 12% of courthouses in Canada are fully wheelchair accessible",
    "🗳️ Voting: 15% of disabled Canadians face barriers when trying to vote",
    "💸 Benefit Trap: Earning $1,000 can reduce ODSP by $500 - discourages work",
    "🏥 MAiD: Medical Assistance in Dying raised concerns about coercion for disabled people",
    "🌍 UN: Canada ratified UN Convention on Rights of Persons with Disabilities in 2010",
    "📊 Data: Statistics Canada disability data is 5+ years old - we need better tracking",
    "🎓 Research: Less than 1% of research funding goes to disability-specific studies",
    "💼 COVID: Disabled workers were 2x more likely to lose jobs during pandemic",
    "🏠 LTC: 70% of long-term care residents have dementia or cognitive disabilities",
    "🚑 Emergency: Disabled people often overlooked in emergency preparedness planning",
    "⚡ Climate: Climate crisis disproportionately impacts disabled communities",
    "🌱 Hope: Youth-led disability movements are growing stronger every year",
    "✊ Change: 2024 saw record number of accessibility lawsuits - accountability is rising",
    "💚 Solidarity: Every social justice movement is strengthened by disability justice"
  ];
