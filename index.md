...
<div class="page-feedback" role="complementary">
  <p><strong><span aria-hidden="true">💬</span> Was this page helpful?</strong></p>
  <p>
    <a href="{{ '/feedback?page=home&helpful=yes' | relative_url }}" class="feedback-btn feedback-yes"><span aria-hidden="true">👍</span> Yes</a>
    <a href="{{ '/feedback?page=home&helpful=no' | relative_url }}" class="feedback-btn feedback-no"><span aria-hidden="true">👎</span> No</a>
    <a href="{{ '/feedback?page=home' | relative_url }}" class="feedback-btn feedback-suggest"><span aria-hidden="true">📝</span> Suggest improvements</a>
  </p>
