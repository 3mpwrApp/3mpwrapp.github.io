...
We completed a full documentation synchronization across app and website, including English and French user-facing pages, legal/policy consistency, beta guides, and downloadable user guides.

## ✅ What Was Updated

### Core user docs (English) {#core-user-docs-en}
- [User Guide](/user-guide/)
- [Features](/features/)
- [FAQ](/faq/)
- [What's New index](/whats-new/)
- [Beta Guide](/beta-guide/)
- [Beta redirect page](/beta/)
...
- [FAQ](/fr/faq/)
- [Quoi de neuf](/fr/whats-new/)
- [Programme bêta](/fr/beta/)

### Legal & policy (French) {#legal-policy-fr}
- [Conditions d'utilisation](/fr/terms/)
- [Politique de confidentialité](/fr/privacy/)
- [Politique relative aux témoins](/fr/cookies/)
...
- What’s New remains the canonical changelog page for public documentation updates.
- This entry acts as the Feb 24, 2026 master rollout index so all linked updates are discoverable from one place.
