...
permalink: /how-to-use-this-data/
---
...
1. **Check if your injury is common:** [See injury patterns](#common-injuries)
2. **Get a template:** [Find templates for your injury type](#templates)
3. **Understand your chances:** [Read about success rates](#success-rates)
4. **Find your city's employer data:** [Check employer safety records](#employer-data)
...
## 🏥 Common Injuries: What We Learned {#common-injuries}
...
## ⚖️ Success Rates: The Confusing Truth {#success-rates}
...
## 📝 Templates: Ready-to-Use Appeal Letters {#templates}

We created templates based on real winning cases.

### How to Use Templates

1. **Find your injury type** in our [template library](/data/templates/)
...
## 🏢 Employer Safety Data: Know Your Workplace {#employer-data}
...
### 4. [Matrix: Injury Types](/injury-industry-matrix.html)

**Shows:** How common each injury type is

**Use it to:** See where your injury ranks

### 5. [Funnel: The Appeal Gap](/wsib-appeal-funnel.html)
...
❌ **Exact success rate** - only 6% of decisions had clear outcome words
❌ **Industry × injury patterns** - need Phase 2 analysis to link industries to injuries
❌ **Individual vice-chair patterns** - didn't extract panel member names yet
❌ **Your specific case** - every case is different
...
- Community Legal Clinics: [Legal Aid Ontario Clinic Locator](https://www.legalaid.on.ca/legal-clinics/)
- Workers' Health & Safety Legal Clinic: [WHSLC](https://www.workers-safety.ca/)
- Office of the Worker Adviser: [OWA](https://www.owa.gov.on.ca/)
...
**Contact:** [feedback page](/feedback/)
