  ...
  return (
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <GapView gap={8} style={[styles.section, { marginTop: 24 }]} accessibilityRole="summary">
...
function createStyles(palette: ReturnType<typeof useAppPalette>, factor: number) {
  return StyleSheet.create({
    ...
    section: { backgroundColor: palette.surface, padding: 16, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: palette.muted },
