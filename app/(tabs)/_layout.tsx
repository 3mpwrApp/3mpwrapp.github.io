      ...
      >
        ...
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarAccessibilityLabel: `Settings tab`,
            tabBarIcon: ({ color, size, focused }) => (
              <Ionicons name={focused ? "settings" : "settings-outline"} color={color} size={size + 2} />
            ),
          }}
        />
        ...
        {/* Hidden routes registry (declared once each) */}
        {/* Resources */}
