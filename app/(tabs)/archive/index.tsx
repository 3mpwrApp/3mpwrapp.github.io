...
export default function ArchiveScreen() {
  ...
  const older = whatsnew.filter((i) => (now.getTime() - new Date(i.date).getTime()) / (1000*60*60*24) > 30);

  return (
    <View style={styles.container}>
      <Text ref={titleRef} style={styles.title} accessibilityRole="header" maxFontSizeMultiplier={MAX_FONT_SCALE}>Archive</Text>
