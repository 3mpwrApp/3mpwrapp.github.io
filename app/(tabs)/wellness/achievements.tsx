...
export default function Achievements() {
    ...
    (async () => {
      try {
        ...
        vals?.forEach(([k, v]: any) => {
          ...
          else if (k === "rehab_streak") setStreak(Number(v) || 0);
          else map[k] = v === "1";
        });
  ...
  const items = [
    {
      id: "achieve_first_steps",
      title: "First Steps",
      desc: "Complete 10 reach & tap reps",
    },
    {
      id: "achieve_calm_breather",
      title: "Calm Breather",
      desc: "Finish 3 breathing cycles",
    },
    {
      id: "achieve_chair_hero",
      title: "Chair Hero",
      desc: "Do 5 sitÃ¢â‚¬â€˜toÃ¢â‚¬â€˜stand reps",
    },
    {
      id: "achieve_consistency",
      title: "Consistency",
      desc: "Reach 50 total points",
    },
    {
      id: "achieve_streak_7",
      title: "Streak",
      desc: "Complete any exercise 7 days in a row",
    },
  ];
