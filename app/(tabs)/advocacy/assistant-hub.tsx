...
export default function AssistantHub() {
  ...
  const extraSuggestions: Array<{ label: string; desc?: string; href: any; tags: string[] }> = [
    ...
    { label: t('resources.tools.deadlines','Deadline Calculator'), desc: t('templates.deadlines.title','Manage appeal and claim deadlines'), href: '/(tabs)/resources/deadlines', tags: ['deadline','due','reminder','calendar','ics','appeal'] },
    { label: t('evidence.manager.title','Evidence Manager'), desc: t('evidence.manager.subtitle','Locker, upload queue, and checklist'), href: '/(tabs)/advocacy/evidence-manager', tags: ['evidence','notes','files','locker','save','upload','checklist'] },
