...
const LESSONS = [
  ...
  },
  {
    ...
    bullets: [
      "Name your need: Ã¢â‚¬Å“I needÃ¢â‚¬Â¦Ã¢â‚¬Â",
...
export default function SelfAdvocacyCoach() {
  ...
  return (
    <ScrollView style={s.container} contentContainerStyle={{ padding: 16 }}>
      ...
      >
        SelfÃ¢â‚¬â€˜Advocacy Coach
      </Text>
      <Text style={s.subtitle}>
        MicroÃ¢â‚¬â€˜lessons for confidence, public speaking, and assertiveness.
      </Text>
      <View
        style={{
          flexDirection: "row",
      ...
      <Text style={[s.subtitle, { marginTop: 12 }]}>
        Practice prompt: Explain your need in one sentence. Example: Ã¢â‚¬Å“I
        need a 10Ã¢â‚¬â€˜minute break every hour due to pain.Ã¢â‚¬Â
      </Text>
    </ScrollView>
  );
}
