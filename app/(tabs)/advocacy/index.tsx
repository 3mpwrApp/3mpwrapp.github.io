...
export default function AdvocacyScreen() {
  ...
  return (
    <View
      ...
      accessibilityLabel="Advocacy screen"
      accessible
    >
      <Text
        ref={titleRef}
      ...
      <Link href={"/(tabs)/advocacy/policy-simple" as any} asChild>
        ...
        >
          {t("advocacy.tools.policy_simple", "Policy Made Simple")}
        </Text>
      </Link>
      ...
      <Link href={"/(tabs)/advocacy/ai-case-interpreter" as any} asChild>
        ...
        >
          {t("advocacy.tools.ai_case", "AI Case Interpreter")}
        </Text>
      </Link>
      <Link href={"/(tabs)/advocacy/collective-legal" as any} asChild>
        ...
        >
          {t("advocacy.tools.collective", "Collective Legal Action Hub")}
        </Text>
      </Link>
      <Link href={"/(tabs)/advocacy/ai-gov-navigator" as any} asChild>
        ...
        >
          {t("advocacy.tools.ai_gov", "AI Government Navigator")}
        </Text>
      </Link>
      ...
      <SearchBar
        ...
        accessibilityLabel="Search advocates"
      />
      {loading && (
        <View>
