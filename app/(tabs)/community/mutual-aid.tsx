...
const Impl: React.ComponentType<any> = isJest
  ? require('./mutual-aid.impl').default
  : React.lazy(async () => ({ default: (await import('./mutual-aid.impl')).default as React.ComponentType<any> }));

export default function MutualAidLazyWrapper() {
