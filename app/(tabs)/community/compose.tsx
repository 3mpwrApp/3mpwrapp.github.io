...
const Impl: React.ComponentType<any> = isJest
  ? require('./compose.impl').default
  : React.lazy(async () => ({ default: (await import('./compose.impl')).default as React.ComponentType<any> }));

export default function CommunityComposeLazyWrapper() {
