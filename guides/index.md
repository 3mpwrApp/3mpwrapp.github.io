...
<ul style="margin: 0.5rem 0 0 1.2rem;">
  <li>How NEL is calculated (Base × Age Factor × Impairment %)</li>
  <li>Challenging WSIB's impairment rating</li>
  <li>AMA Guide interpretations and errors</li>
  <li>Sample appeal language and strategies</li>
</ul>
<a href="/guides/wsiat-nel-benefits/" style="display: inline-block; margin-top: 0.5rem; padding: 0.5rem 1rem; background: #0066cc; color: white; text-decoration: none; border-radius: 4px;">Read NEL Guide →</a>
</div>
...
<strong>What's covered:</strong>
<ul style="margin: 0.5rem 0 0 1.2rem;">
  <li>LOE calculation formula (85% of wage loss)</li>
  <li>Challenging "deemed earnings"</li>
  <li>Pre-injury earnings disputes (overtime, bonuses)</li>
  <li>Non-cooperation traps and how to avoid</li>
</ul>
<a href="/guides/wsiat-loe-benefits/" style="display: inline-block; margin-top: 0.5rem; padding: 0.5rem 1rem; background: #0066cc; color: white; text-decoration: none; border-radius: 4px;">Read LOE Guide →</a>
</div>
...
<strong>What's covered:</strong>
<ul style="margin: 0.5rem 0 0 1.2rem;">
  <li>Why chronic pain is hard to win (no objective test)</li>
  <li>Proving chronic pain with medical specialists</li>
  <li>Countering "pain out of proportion to injury"</li>
  <li>Chronic pain + NEL/LOE strategies</li>
</ul>
<a href="/guides/wsiat-chronic-pain-claims/" style="display: inline-block; margin-top: 0.5rem; padding: 0.5rem 1rem; background: #0066cc; color: white; text-decoration: none; border-radius: 4px;">Read Chronic Pain Guide →</a>
</div>
...
## 💡 Pro Tips from 40 Years of Data
...
## 🆚 Ontario vs. BC: Transparency Gap
